...
export default function HomePage() {
  ...
  const sliderOffset =
    sliderRef.current ? sliderRef.current.clientWidth * portfolioIndex : 0;
      ...
      <section className="hero">
        ...
        <div className="container hero-shell">
          <div className="hero-copy" data-reveal>
            <span className="eyebrow">Disciplined early-stage investing since 2008</span>
            <h1>Backing exceptional early-stage founders.</h1>
            <p className="hero-sub">
              Park City Angels is a network of experienced operators and accredited investors
              supporting ambitious founders across the United States with capital, guidance, and
            ...
            <div className="hero-actions">
              ...
              <Link className="text-link" href="/funding-process">
                View Our Process
              </Link>
            </div>
      ...
      <section className="section-band section-band-a">
        <div className="container about-grid">
          <div className="about-lead" data-reveal>
            <p className="section-kicker">Why Park City Angels</p>
            <h2>Investors seeking disruptive entrepreneurs.</h2>
            <p>
              Founders should leave the first interaction feeling that the network is thoughtful,
              experienced, and useful. That means clear expectations, disciplined screening, and
              members who bring operating context in addition to capital.
            </p>
          </div>
          ...
          <div className="stats-grid">
            ...
            <article className="stat-card" data-reveal>
              <span>Individual investments</span>
              <strong>1,275+</strong>
            ...
            <article className="stat-card" data-reveal>
              ...
              <strong>100+</strong>
              <p>
                A community of operators, founders, and accredited investors with practical
                perspective.
              </p>
            </article>
            <article className="stat-card" data-reveal>
              <span>Entrepreneur meetings</span>
              <strong>750+</strong>
              <p>
                Consistent founder engagement built around process clarity and constructive
                evaluation.
              </p>
            </article>
          </div>
        ...
        <div className="container">
          <div className="section-head" data-reveal>
            <div>
              ...
              <h2>What earns our attention.</h2>
            </div>
            <p className="section-copy">
              We look for opportunities where founder quality, market opportunity, traction, and
              network fit all line up. The best companies are not only compelling on paper. They are
              companies our members can genuinely help.
            </p>
          </div>
          ...
          <div className="thesis-grid">
            <article className="thesis-card" data-reveal>
              ...
              <p>
                We back leaders who understand their customers deeply and can translate insight into
                fast, disciplined execution.
              </p>
            </article>
            <article className="thesis-card" data-reveal>
              ...
              <p>
                We look for categories with meaningful demand and a clear path to becoming more
                important over time.
              </p>
            </article>
            <article className="thesis-card" data-reveal>
              ...
              <p>
                Early proof matters. Customer pull, retention, and execution momentum tell us more
      ...
      <section className="section-band section-band-a" id="portfolio">
        <div className="container">
          ...
          <div className="portfolio-slider-shell">
            <button
              className="portfolio-arrow prev"
              type="button"
              aria-label="Show previous portfolio logo"
              onClick={() => goToSlide(portfolioIndex - 1)}
            >
              &#8592;
            </button>
            <div
              ...
              ref={sliderRef}
              data-reveal
              aria-label="Selected portfolio company logos"
            >
              <div
                className="portfolio-track"
                style={{
                  transform: `translate3d(-${sliderRef.current ? sliderRef.current.clientWidth * portfolioIndex : 0}px, 0, 0)`,
                }}
              >
            ...
            <button
              ...
              type="button"
              aria-label="Show next portfolio logo"
              onClick={() => goToSlide(portfolioIndex + 1)}
            >
              &#8594;
            </button>
      ...
      <section className="section-band section-band-b" id="founders">
        <div className="container">
          <div className="section-head" data-reveal>
            ...
            <p className="section-copy">
              Whether you are raising capital or considering membership, the experience should feel
              organized, warm, and worth your time.
            </p>
          </div>
          ...
          <div className="audience-grid">
            <article className="audience-card" data-reveal>
              ...
              <p>
                Access capital from experienced operators and investors who can help with hiring,
                customer access, strategic clarity, and readiness for future fundraising.
              </p>
            ...
            <article className="audience-card" id="investors" data-reveal>
              ...
              <p>
                Participate in screened deal flow, collaborative diligence, and a member base that
                brings operating and investing experience to the table.
              </p>
              <ul className="feature-list">
